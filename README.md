...
* Bump the main release project and subprojects using `mvn versions:set -DnextSnapshot -DprocessDependencies=false` (with `git submodule foreach` for the children)
